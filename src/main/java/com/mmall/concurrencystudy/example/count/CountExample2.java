package com.mmall.concurrencystudy.example.count;
...
/**
 * 与CountExample1相比,只改动了3处,就由线程不安全的类变为了线程安全的类. int -> AtomicInteger
 */
@Slf4j
@ThreadSafe
